// src/lib.rs
/*
 * Core library for RhythmToolkit
 */
...
#[derive(Debug)]
pub struct RhythmToolkitProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RhythmToolkitProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RhythmToolkit processing");
    
    let mut processor = RhythmToolkitProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RhythmToolkitProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RhythmToolkitProcessor::new(false);
